<div class="d-flex" id="wrapper">
    ...
    <div class="text-white bg-green" id="sidebar-wrapper">
        ...
        <div class=" list-group">
            <a class="p-3 border-0 list-group-item bg-green list-group-item-action list-group-item-light"
                href="" style="color:white"> <i class='fa fa-icon '></i> Buku</a>
        </div>
    </div>
    <!-- Sicebar End -->
    ...
    <div id="page-content-wrapper" >
        ...
        <header class="mb-3 bg-light border-bottom bg-green" style="background-color:#23717D">
            <div class="py-3 text-white container-fluid align-items-center bg-green" style="grid-template-columns: 1fr 2fr;">
                    ...
                    <div class="flex-shrink-0 px-1 dropdown">
                        <a href="#" class="d-block link-light text-decoration-none " id="dropdownUser2"
                            ...
                            <img src="{{ asset('images/user.png') }}" alt="Username"
                                width="30" height="30" class="bg-white border rounded-circle">
                        </a>
